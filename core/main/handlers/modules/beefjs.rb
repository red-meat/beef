      ...
      module Modules
        ...
        module BeEFJS
          ...
          def build_beefjs!(req_host)
            ...
            # Modified jquery file name to reflect version change(1.12.4 > 3.4.1).20190526.Blair
            ext_js_sub_files = %w(lib/jquery-3.4.1.min.js lib/jquery-migrate-1.4.1.js lib/evercookie.js lib/json2.js lib/mdetect.js lib/platform.js lib/jquery.blockUI.js)
